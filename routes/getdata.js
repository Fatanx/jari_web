...
var people = [/*{
        ...
        tags:["综合型种子选手","标书组中坚力量","沟通协调小能手","调优实习生"],
        records:[{
            record:"数据初始化",
            date:'2020-2-1'
        }]
